<?php
  ...
  if (!$customers->customerlogged_in)
	  ...
	  if(isset($_POST['patment_type']) && !empty($_POST['patment_type'])){
		 ...
		 $_SESSION['access_type'] = (isset($_POST['web_access_type'])) ? $_POST['web_access_type'] : "";
	 }
	 else{
      ...
      : redirect_to("../checkout.php");
  	  ...
  	  if(!empty($_POST['patment_type'])):
	  	if($_POST['patment_type']=='is_mercury'):
				...
				$ProcessCompleteUrl = "".SITEURL."/payment/returnmercury.php";
				if($_SESSION['access_type']=='c'){
					$ReturnUrl  = "".SITEURL."/checkout.php";
					$LogoUrl = "".THEMEURL."/images/mercury_banner.jpg";
				} else {
				...
				{				
					$hostedCheckoutURL = "https://hc.mercurypay.com/Checkout.aspx"; //live url
...
?>
<img src="<?php echo SITEURL; ?>/payment/paymentprocess.gif" alt="Loading.........." />