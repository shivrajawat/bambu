<?php
  ...
  if (!$customers->customerlogged_in)
	 ...
	 if(isset($_POST['patment_type']) && $_POST['patment_type'] =='is_authorize' ){
			 ...
			 $_SESSION['access_type'] = (isset($_POST['web_access_type'])) ? $_POST['web_access_type'] : 0;
	 }
	 else{
		    $_SESSION['paymentAmount'] = $_SESSION['paymentAmount2'];
			$_SESSION['access_type'] = $_SESSION['paymentform2']['web_access_type'];
	 }	
...
if ($METHOD_TO_USE == "AIM"){
    ...
    $transaction->setFields(
        array(
        'amount' => $_SESSION['paymentAmount']['neat_amount'], 
    ...
    if ($response->approved){
        	 // Transaction approved! Do your logic here.
			  ...
			  if( $_SESSION['authorize']['patment_type']=='cash'){	$payment_type = "c";  }
			  else  { $payment_type = "o";  }
...
?>
<?php
/****************************For Standard site, form starts here*************************************************/ 
if($_SESSION['access_type']=='c'){
...
<div class="container">
  <div class="row-fluid margin-top ">
    <div class="span12 padding-top-10 padding-bottom-10 relative"> 
      <div class="span12 span10 reg-bg" style="margin-left:30%">        
   <?php
      ...
      <fieldset>
        <div class="control-group ">
            <div class="clearfix">
                ...
                <input type="text" class="text required creditcard input-xlarge" size="15" name="x_card_num" value=""></input>
            </div>
        </div>
        <div>
          <label>Exp.</label>
          <input type="text" class="text required input-xlarge" size="4" name="x_exp_date" value=""></input>
        </div>
        <div>
          <label>CCV</label>
          <input type="text" class="text required input-xlarge" size="4" name="x_card_code" value=""></input>
        </div>
      </fieldset>      
      <input type="submit" value="Place order" class="btn-2-2" name="submitauthorized">
    </form>
      </div>
    </div>
    <div class="clr"></div>
...
/****************************For Standard site, form ends here*************************************************/ 
/****************************For mobile site, form starts here***************************************************/
else { 
?>
...
<?php 
/****************************For mobile site, form ends here***************************************************/
 	}  
 ?>