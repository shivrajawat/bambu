...
* Index
*
* @package Kulacart pro
* @author G7web
*/
define("_VALID_PHP", true);


//Mobile or desktop browser detection and redirect to respective web page throuth php
...
header('Location: https://bambu.kulacart.net/mobile');
}
...
else
{
	...
	elseif($webrow['test_mode']=='1'){ 
	
		require_once(THEMEDIR . "/menuby.php");
	 }
	elseif($webrow['flow']=='1') // website flow check if flow location by then 1 else menu page open
	{
