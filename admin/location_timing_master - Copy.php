    ...
    <form action="#" method="post" id="admin_form" name="admin_form">
      ...
      <table width="98%" cellspacing="0" cellpadding="0" border="0" class="forms" id="show_timemenu">
         <tbody>          
            ...
            <tr>
              <th>&nbsp;&nbsp;<strong><?php echo $mrow['days']; ?></strong></th>
              <td height="30"><input type="text" style="width: 70px;" class="timepicker inputbox" name="days[<?php echo ucfirst($mrow['days']);?>][breakfast_start]" value="<?php echo $mrow['breakfast_start'];?>" /></td>
              <td height="30"><input type="text" style="width: 70px;" class="timepicker inputbox" name="days[<?php echo ucfirst($mrow['days']);?>][breakfast_end]" value="<?php echo $mrow['breakfast_end'];?>" /></td>
              <td height="30"><input type="text" style="width:60px;"  class="timepicker inputbox" name="days[<?php echo ucfirst($mrow['days']);?>][breakfast_last]" value="<?php echo $mrow['breakfast_last'];?>"></td>
              <td height="30"><input type="text" style="width:60px;"  class="timepicker inputbox" name="days[<?php echo ucfirst($mrow['days']);?>][launch_start]" value="<?php echo $mrow['launch_start'];?>"></td>
              <td height="30"><input type="text" style="width:60px;"  class="timepicker inputbox"  name="days[<?php echo ucfirst($mrow['days']);?>][launch_end]" value="<?php echo $mrow['launch_end'];?>"></td>
              <td height="30"><input type="text" style="width:60px;"  class="timepicker inputbox"  name="days[<?php echo ucfirst($mrow['days']);?>][launch_last]" value="<?php echo $mrow['launch_last'];?>"></td>
              <td height="30"><input type="text" style="width:60px;"  class="timepicker inputbox"  name="days[<?php echo ucfirst($mrow['days']);?>][dinner_start]" value="<?php echo $mrow['dinner_start'];?>"></td>
              <td height="30"><input type="text" style="width:60px;"  class="timepicker inputbox"  name="days[<?php echo ucfirst($mrow['days']);?>][dinner_end]" value="<?php echo $mrow['dinner_end'];?>"></td>
              <td height="30"><input type="text" style="width:60px;"  class="timepicker inputbox"  name="days[<?php echo ucfirst($mrow['days']);?>][dinner_last]" value="<?php echo $mrow['dinner_last'];?>"></td>
            </tr>
            <?php endforeach;?>   
          </tbody>
        </table>   
