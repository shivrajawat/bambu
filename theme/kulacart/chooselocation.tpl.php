          ...
          <form name="checkoutform" action="<?php echo SITEURL;?>/" method="post" id="checkoutform">
            <div class="span12 fit">
              ...
              <div class="span12 fit btn_back_next">
                <div class="span2">
                  <div> <a href="javascript:goback()" title="Back"><img src="<?php echo THEMEURL; ?>/images/btn_back.png" alt=""? /> </a> </div>
                </div>
                <div class="clr"></div>
              </div>
            </div>
...
?>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDY0kkJiTPVd2U7aTOAwhc9ySH6oHxOIYM&sensor=false&libraries=places"></script> 
<script type="text/javascript">
