                ...
                <div class="span6">
                  <div class="pyment-process">
                    ...
                    <label class="checkbox checkbox1"> <input type="radio" name="patment_type" id="is_authorize" value="is_authorize" /> Secure Credit Card Payment</label>
                     ...
                     <?php }if($payment['is_vm']==1){?>
                    <label class="checkbox checkbox1"><input type="radio" name="patment_type" id="is_vm" value="is_vm" /> Secure Credit/Debit Card Payment</label>
...
$('#is_vm').click(function(){
   $('#paymentform').attr('action', '<?php echo SITEURL;?>/payment/virtual_merchant.php');
});
