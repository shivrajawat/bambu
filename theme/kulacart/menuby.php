...
<div id="demo2-html">
  <?php $menurow = $menu->CategoryMenuSubMenu($locationid);
			if($menurow != 0)
			{
				...
				$str .= "<li class=\"accordion-group\">";
				$str .= "<a href=\"#all\">All Items</a>";
				$str .= "</li>";
				$c = 0;
...
//	   });   			
  ...
  var cartrowid = "";
	...
	function getallproduct(){ 
			...
			var data = 'OnloadProduct= 1' + '&ordertime=' + encodeURIComponent('<?php echo $ordertime; ?>') + '&availabledays=' + '<?php echo $availabledays; ?>' + '&locationid=' + <?php echo $locationid;?>;
